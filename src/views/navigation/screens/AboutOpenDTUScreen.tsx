      ...
      <StyledSafeAreaView theme={theme}>
        <Box style={{ width: '100%', flex: 1 }}>
          <ScrollView>
            <List.Section>
              <List.Subheader>
                {t('opendtu.systemInformationScreen.firmwareInformation')}
              </List.Subheader>
              <List.Item
            ...
            <List.Section>
              <List.Subheader>
                {t('opendtu.systemInformationScreen.hardwareInformation')}
              </List.Subheader>
              <List.Item
            ...
            <List.Section>
              <List.Subheader>
                {t('opendtu.systemInformationScreen.memoryInformation')}
              </List.Subheader>
              <List.Item
              ...
              <List.Item
                ...
                )} / ${formatBytes(systemStatus?.littlefs_total)} (${percentage(
                  systemStatus?.littlefs_used,
            ...
            <List.Section>
              <List.Subheader>
                {t('opendtu.systemInformationScreen.radioInformation')}
              </List.Subheader>
              <List.Item
              ...
              />
              <List.Item
                title={t('opendtu.systemInformationScreen.cmt2300aChipStatus')}
                description={
