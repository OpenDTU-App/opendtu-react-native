          ...
          <Box p={16}>
            ...
            <Text variant="bodySmall" style={{ color: theme.colors.onSurface }}>
              {t('deviceSettings.status', {
                status:
                  DeviceState[deviceState] ?? DeviceState[DeviceState.Unknown],
              })}
            </Text>
            <Text variant="bodySmall" style={{ color: theme.colors.onSurface }}>
            ...
            {config.customName !== null ? (
              ...
              >
                {t('deviceSettings.deviceName', { name: config.customName })}
              </Text>
            ) : null}
            ...
            <>
              ...
              <Box p={16}>
                {hints?.default_password ? (
                  <Text
                    variant="bodySmall"
                    style={{ color: theme.colors.error, marginVertical: 4 }}
                  >
